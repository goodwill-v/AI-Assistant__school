...
### 1. **Осмысленное ведение диалога**
   ...
   - Распознает изображение на картинках и отвечает в контексте содержания изображения и диалога.
   - Распознает текст на фото, переводит или напечатает в сообщении по запросу.
...
6. **Распознание изображений:**
   - Отправляем фото, картинку — бот продолжает диалог с учетом содержания изображения.
![Скрин_Фото - контекст](https://github.com/goodwill-v/AI-Assistant__school/blob/9fc12827898b85338333c2d3ec8a9cb57a381b1f/4.png?raw=true)
![Скрин_Фото — контекст](https://github.com/goodwill-v/AI-Assistant__school/blob/9fc12827898b85338333c2d3ec8a9cb57a381b1f/5.png?raw=true)
   - Отправляем изображение с текстом. Получаем перевод текста. Или можно попросить ассистента написать оригинальный текст изображения в сообщении.
![Скрин_Фото - текст](https://github.com/goodwill-v/AI-Assistant__school/blob/9fc12827898b85338333c2d3ec8a9cb57a381b1f/6.png?raw=true)
---
...
- Создать опции по запросу заказчиков. ЖДЁМ ВАШИХ ПРЕДЛОЖЕНИЙ!
